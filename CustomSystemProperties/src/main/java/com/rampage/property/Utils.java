...
public class Utils {
    ...
    public static boolean isPropertiesInAosp(String propertyName) {
        return AppConfig.propertiesInAosp.contains(propertyName);
    }
    ...
    public static void main(String[] args) {
        List<String> reflectedClassNames = new ArrayList<>();
        reflectedClassNames.add("android.os.");
        reflectedClassNames.add("SystemProperties");
        System.out.println(AppConfig.acceptedClasses.stream().anyMatch(reflectedClassNames::contains));
    }
}
